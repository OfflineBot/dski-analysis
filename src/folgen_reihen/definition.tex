...
\[
    \begin{aligned}
        ...
        a_{n+1} &= n + 1 - (n^2 + 2n + 1) \\
        a_{n+1} &= n - n^2 - 2n \\
        a_n = n - n^2 > n-n^2 - 2n &= a_{n + 1} \ | \ n - n^2 = a_n
    \end{aligned}
\]
...
$\displaystyle\lim_{n\rightarrow\infty} [(-1)^n + \frac{1}{n}] = +1 \text{ für gerade;} -1 \text{ für ungerade}$

Die Folge $a_n = (-1)^n + \frac{1}{n}$ ist beschränk, da gilt:

\[
    \begin{aligned}
        |a_n| \leq 1.5 = \frac{3}{2} | c = 1.5 \ \ a_n \epsilon \ ]-1; 1.5]
    \end{aligned}
\]
...
$\displaystyle\lim_{n\rightarrow\infty} \frac{3n^2}{4n^2+n+5} \rightarrow \frac{3}{4}$ weil man mit $n^2$ alle Werte multipliziert

\point{Beispiel 2}

\[\lim_{n\rightarrow\infty} \frac{3n^3}{4n^2 + n + 5} \rightarrow \infty\]

\point{Beispiel 3}

\[\lim_{n\rightarrow\infty} \frac{3n^2}{4n^3 + n + 5} = 0\]


\subsection{Reihen - Eigenschaften}

\subsubsection{Grenzwerte von Reihen}

Bei arithmetischen Reihen gibt es keinen Grenzwert.

Bei geometrischen Reihen einen Grenzwert, sofern für den Quotienten $q$ gilt: $|q| < 1$. Der Grenzwert ist dann:

\[
\lim_{n\rightarrow\infty} 
\sum_{i=1}^{n} a_i\ q^{i-1} = a_i \cdot \frac{1}{1-q}
\]
...
Anfangsglied $a_1 = 1; q = \frac{1}{2}$ 

\[
\lim_{n\rightarrow\infty} \sum_{i=1}^{n}\frac{1}{2^{n-1}} = \frac{1}{1-\frac{1}{2}} = 2
\]
...
\[
    \sum_{i=2}^{\infty} 5 \cdot (\frac{1}{3})^i = \frac{5}{9} + \frac{5}{27} + \frac{5}{81} + ... = \frac{5}{9} \cdot \frac{1}{1-\frac{1}{3}}  = \frac{5}{9\frac{1}{3}} \cdot \frac{3}{2} = \frac{5}{6}
\]

Beachte das $i=2$!

Für $i=1$ wäre der Grenzwert $\frac{5}{6} + \frac{5}{3} = \frac{5}{2}$. Dabei ist $\frac{5}{3}$ der Wert für $i=1$ \textbf{nicht} summiert.
